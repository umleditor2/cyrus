...
public class DrawingSplitPane extends JSplitPane {
	/*
	 * <p>This class contains two panels. One panel containing drawing
	 * interactive capabilities. The other panel containing detail features of a
	 * diagram.</p>
	 */

	/*
	 * <p>Drawing surface represents the grid on which the drawing takes
	 * place.</p>
	 */
	...
	/*
	 * <p>DetailPanel represents detailed info of an element based on user
	 * selection</p>
	 */
